...
public class Viewothersplots extends AppCompatActivity implements JsonResponse,AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) Viewothersplots.this;
        String q = "/viewothersplot?logid="+Login.logid;
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
...
//        st=stock[i];
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Viewothersplots.this);
